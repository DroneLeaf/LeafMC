...
GuidedToolStripAction {
    ...
    property bool   hideMRFTAlt: !_guidedController._fcMRFTPitchOn && !_guidedController._fcMRFTRollOn && !_guidedController._fcMRFTYawOn && !_guidedController._fcMRFTXOn && !_guidedController._fcMRFTYOn
