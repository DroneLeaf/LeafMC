...
GuidedToolStripAction {
    ...
    property bool   hideMRFTPitch: !_guidedController._fcMRFTAltOn && !_guidedController._fcMRFTRollOn && !_guidedController._fcMRFTYawOn && !_guidedController._fcMRFTXOn && !_guidedController._fcMRFTYOn
