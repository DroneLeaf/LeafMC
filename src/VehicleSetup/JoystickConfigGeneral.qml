                ...
                GridLayout {
                    ...
                    Connections {
                        ...
                        onAxisValues: (roll, pitch, yaw, throttle, gimbalPitch, gimbalYaw) => {
                            ...
                            // If gimbal monitors exist, update them (they will be placed after throttle)
                            if (gimbalPitchAxis) { gimbalPitchAxis.axisValue = gimbalPitch * 32768.0 }
                            if (gimbalYawAxis)   { gimbalYawAxis.axisValue   = gimbalYaw   * 32768.0 }
                        }
                    }
                }
            }
